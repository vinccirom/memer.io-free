...
const drawCells = (cells, playerConfig, toggleMassState, borders, graph, skinLoader) => {
    for (let cell of cells) {
        // Check if cell has a skin
        const skinImage = cell.skin && cell.skin !== 'none' && skinLoader ? skinLoader(cell.skin) : null;
        ...
        if (skinImage && skinImage.complete && skinImage.naturalWidth > 0) {
            ...
            // Draw the skin image to fill the circle
